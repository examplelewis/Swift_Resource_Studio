...
class GYFoundation {
    // MARK: Time
    static func humanReadableTime(fromInterval interval: TimeInterval) -> String {
    ...
    // MARK: Export
    static func export(toPath path: String, string: String?, continueWhenExist: Bool, showSuccessLog: Bool) {
    ...
    static func export(toPlistPath path: String, data: Data, continueWhenExist: Bool, showSuccessLog: Bool) {
    ...
    // MARK: Read
    static func readTextFile(atPath filePath: String) -> String? {
        var content: String?
        do {
